package namazon;
import namazon.exceptions.AccountCreationException;
...
import java.util.regex.Pattern;
    ...
    public class Namazonn {
        ...
        public void start() throws AccountCreationException, NotInInventoryException {
            Account account;
        ...
        private Product addProductToInventory(Vendor vendor) {
            ...
            while (addingProducts) {
                ...
                System.out.println("3) " + ProductCategory.HOME_APPLIANCES);
                ...
                switch (choice) {
                    ...
                    case 3 -> product = createProduct(ProductCategory.HOME_APPLIANCES, vendor);
        ...
        private Order purchase(Vendor vendor, Customer customer) throws NotInInventoryException {
            ...
            while (purchasing) {
                ...
                else if (choice < 0 || choice > vendors.size())
        ...
        public static void main(String[] args) throws AccountCreationException, NotInInventoryException {
            Namazonn namazon = new Namazonn();
            namazon.start();
